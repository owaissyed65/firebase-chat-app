...
const PopupWrapper = (props) => {
    return (
        <div className='fixed top-0 left-0 w-full h-full flex justify-center items-center z-20'>
            ...
            <div className={`flex flex-col bg-c2 w-[500px]  max-h-[80%] relative rounded-3xl px-3 ${!props.shortHeight && "min-h-[500px]"}`}>
                {!props.noHeader && <div className="shrink-0 flex justify-between items-center py-3">
